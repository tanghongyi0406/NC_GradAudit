...
def load_model_with_lora(base_model_path: str, lora_dir: str):
    ...
    # Required by the pinned Transformers 4.52.4 single-GPU runtime. No tensor
    # parallel execution is requested; this only restores its style registry.
    if modeling_utils.ALL_PARALLEL_STYLES is None:
        modeling_utils.ALL_PARALLEL_STYLES = {"colwise": None, "rowwise": None}
